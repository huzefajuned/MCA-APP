...
export default function AssignmentView({ studentName, rollNumber, enrolmentNumber, onBack }: AssignmentViewProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto w-full">
      ...
      >
        {/* COVER PAGE */}
        <div className="flex flex-col items-center min-h-[1050px] text-center pb-12 break-after-page font-sans bg-white relative print:p-0 print:border-none">
          <h3 className="text-[1.1rem] font-bold mt-[4rem] mb-2 text-gray-900">A Lab Manual For</h3>
          <h1 className="text-[1.8rem] font-extrabold text-[#3a5b88] mb-2 uppercase tracking-wide">JAVA PROGRAMMING LAB</h1>
          <h2 className="text-[1.2rem] font-bold text-[#3a5b88] mb-8 tracking-widest">MMCA262PCP</h2>
          ...
          <div className="text-[1.1rem] font-medium mb-4">2025-26</div>
          ...
          <div className="text-center w-full relative z-10 px-8">
            ...
            <h2 className="text-[1.4rem] font-bold uppercase tracking-tight mb-1">MAULANAAZADNATIONALURDU UNIVERSITY</h2>
        ...
        {/* CERTIFICATE PAGE */}
        <div className="flex flex-col min-h-[1050px] pt-[3rem] text-center pb-12 break-after-page font-sans bg-white relative px-10 print:p-0 print:border-none">
        ...
        {/* INDEX PAGE 1 */}
        <div className="flex flex-col min-h-[1050px] pt-12 pb-12 break-after-page font-sans bg-white relative px-10 print:p-0 print:border-none">
        ...
        {/* INDEX PAGE 2 */}
        <div className="flex flex-col min-h-[1050px] pt-[3rem] pb-12 break-after-page font-sans bg-white relative px-10 print:p-0 print:border-none mt-[0.5rem]">
          <div className="w-full border-[1.5px] border-black border-t-[1.5px]">
            {Array.from({ length: 24 }).map((_, i) => { 
               ...
               const hasTitle = program?.title;
               return (
                 <div key={programIndex} className="grid grid-cols-[8%_13%_59%_9%_11%] w-full border-b border-black text-center divide-x divide-black text-sm" style={{ minHeight: '35px' }}>
                    <div className="p-1 flex items-center justify-center font-semibold text-[14px]">{hasTitle ? programIndex + 1 : ''}</div>
                    <div className="p-1 flex items-center justify-center"></div>
                    <div className="p-2 flex items-center justify-center text-center text-[13px] leading-snug px-3">{hasTitle ? program.title : ''}</div>
                    <div className="p-1 flex items-center justify-center"></div>
                    <div className="p-1 flex items-center justify-center"></div>
          ...
          <div className="absolute right-8 bottom-4 text-xs font-sans">4</div>
        </div>
          ...
          {programs.map((prog, index) => {
            ...
            return (
              <div key={prog.id} className={`${index > 0 ? 'mt-16 pt-16 border-t border-gray-300' : ''} program-container break-inside-avoid shadow-sm print:shadow-none p-6 border rounded-lg print:border-none print:p-0 mb-12 page-break-after-auto`} style={{ pageBreakInside: 'avoid' }}>
                ...
                <div>
                  <h4 className="font-bold text-gray-800 mb-3 border-l-4 border-gray-400 pl-2">Output Verification (Simulated Target):</h4>
                  <TerminalOutput 
